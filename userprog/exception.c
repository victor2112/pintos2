...
kill (struct intr_frame *f) 
{
  ...
  switch (f->cs)
    ...
    case SEL_UCSEG:
      ...
      //CC7 - Necesitamos marcar el pcb con el codigo de salida
      syscall_exit(-1); 
...
page_fault (struct intr_frame *f) 
{
  ...
  /*
  CC7 Se aplica lo comentado en la documentacion de pintos
   They also assume that you've modified page_fault() so that a page fault in the kernel merely 
